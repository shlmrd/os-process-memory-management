...
#ifdef NETWORK
"NETWORK\n"
"-on -sc de test de la console synchrone qui lance la fonction ConsoleDriverTest que lon a ajn sets the network reliability\n"
    ...
    for (argc--, argv++; argc > 0; argc -= argCount, argv += argCount)
      {
          ...
          if (!strcmp (*argv, "-cp"))
            ...
            {                        // remove Nachos file
                ...
                fileSystem->Remove (*(argv + 1));./nachos -c
                argCount = 2;
            }

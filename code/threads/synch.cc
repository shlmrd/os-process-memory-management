...
//----------------------------------------------------------------------
// Lock::Lock
//      Initialize a mutex, based on a binary semaphore
//      "debugName" is an arbitrary name, useful for debugging.
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
// Lock::Acquire
//      The mutex is taken. If it is already in use, the current thread 
...
Lock::Acquire ()
{
    ASSERT_MSG(holder != currentThread, "Le thread possède déja un verrou\n");
    semaphore->P();
...
Lock::Release ()
{
    ASSERT_MSG(holder == currentThread, "Erreur : verrou libéré par un non propriétaire\n");
    holder = NULL;
    semaphore->V();
}
#endif //CHANGED
